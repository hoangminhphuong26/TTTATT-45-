...
/**
 *
 *Viết chương trình đếm số các số Carmichael (là các số giả nguyên tố n thoả mãn điều
...
public class baii29 {
    ...
    public static void main(String[] args) {
        ...
        Sieve(n);
        int count = 0;
        System.out.print("Cac so thoa man la: ");
        for (int i = 2; i <= n; i++) {
            if (solve(i)) {
                System.out.print(i + " ");
                count++;
        ...
        System.out.println("");
        System.out.print("So cac so thao man la: " + count);
    }
